  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-blue-50">
        ...
        >
          <p className="text-gray-600 text-lg">Loading hobby...</p>
        </motion.div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          {hobby.description && <p className="text-gray-700 mb-6">{hobby.description}</p>}
          ...
          {hobby.meta?.subskills && hobby.meta.subskills.length > 0 && (
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {hobby.meta.subskills.map((skill: string, index: number) => (
                  <span
                    key={index}
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    {activity.ai_skills && activity.ai_skills.length > 0 && (
                      <div className="flex flex-wrap gap-2">
                        {activity.ai_skills.map((skill: string, idx: number) => (
                          <span
                            key={idx}
